...
<html>
    <head>
        <title>Modifier <?php echo $materiel['nom']; ?></title>
        <meta charset="utf-8">
    </head>
    <body>
        <h1>Modifier <?php echo $materiel['nom']; ?></h1>
        ...
        <form action="materiel_edit.php?id=<?php echo $data;?>" method="post">
            ...
            <br>
            <input type="submit" name="updateMateriel" value="Valider"> <input type="reset" value="Annuler">
